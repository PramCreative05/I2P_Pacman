...
//valgrind --leak-check=full ./pacman
...
static const char* game_title = "I2P(I)_2023: Final Pacman";
...
static void game_destroy(void) {
	...
	al_destroy_user_event_source(al_get_keyboard_event_source());
	al_destroy_user_event_source(al_get_mouse_event_source());

	al_destroy_display(game_display);

	free(mouse_state);

	game_log("Game Destroyed");
}
